    ...
    render(){
        return(
            <React.Fragment>
                    ...
                    <form class="form">
							<div class="form-body">
								<h4 class="form-section"><i class="icon-head"></i> Add Product</h4>
								<div class="row">
									<div class="col-md-6">
										<InputField
										label="Title"
								...
								<div class="row">
									...
									onChange={(e)=>{
										this.setState({brand:e.target.value,brandError:false})
									}}
									>
									</InputField>
									</div>
								...
								<div class="row">
									...
									onChange={(e)=>{
										this.setState({units:e.target.value,unitError:false})
									}}
									>
									</InputField>
									</div>
