  ...
  return (
    ...
    <div className="navbar-wrapper">
        ...
        <ul className="nav navbar-nav">
            ...
            <li className="nav-item"><a href="index.html" className="navbar-brand nav-link"><img alt="branding logo" src="../../app-assets/images/logo/robust-logo-light.png" data-expand="../../app-assets/images/logo/robust-logo-light.png" data-collapse="../../app-assets/images/logo/robust-logo-small.png" className="brand-logo"   /></a></li>
            ...
            <ul className="nav navbar-nav float-xs-right">
              ...
              <li className="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" className="nav-link nav-link-label"><i className="ficon icon-mail6"></i><span className="tag tag-pill tag-default tag-info tag-default tag-up">8</span></a>
                <ul className="dropdown-menu dropdown-menu-media dropdown-menu-right">
                  ...
                  <li className="list-group scrollable-container"><a href onClick={(e) => {e.preventDefault(); }} className="list-group-item">
                      <div className="media">
                        <div className="media-left"><span className="avatar avatar-sm avatar-online rounded-circle"><img src="../../app-assets/images/portrait/small/avatar-s-1.png" alt="avatar" /><i></i></span></div>
                        <div className="media-body">
              ...
              <li className="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" className="dropdown-toggle nav-link dropdown-user-link"><span className="avatar avatar-online"><img src="../../app-assets/images/portrait/small/avatar-s-1.png" alt="avatar" /><i></i></span><span className="user-name">John Doe</span></a>
